...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { author: @libro.author, lended_at: @libro.lended_at, returned_at: @libro.returned_at, state: @libro.state, title: @libro.title } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { author: @libro.author, lended_at: @libro.lended_at, returned_at: @libro.returned_at, state: @libro.state, title: @libro.title } }
